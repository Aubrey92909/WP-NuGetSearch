...
namespace NuGetApiClientLib
{
    ...
    public class NuGetOrgSearcher : INuGetSearcher
    {
        ...
        public async Task<Response<IEnumerable<V2FeedPackage>>> GetMostPopularPackages(int pageIndex)
        {
            var nugetClient = new NuGetApiClient("https://www.nuget.org/api/v2/");
        ...
        public async Task<Response<IEnumerable<V2FeedPackage>>> GetTopMicrosoftDotNetPackages(int pageIndex)
        {
